...
def main():
    ...
    gamma_obj = joblib.load(config['gamma_model_path'])
    pipe=Pipeline(steps=[('rf',rf_obj),('gamma',gamma_obj),('pillcount',Yolov4Classifier())]) 
    ...
    for line in content:
        ...
        y_pred_wo_class=yolov4only.transform_predict([[img,annot,None,'good','1']])
